...
//    g_pParticleSystems[1]->SetTexture( "..\\particle.bmp" );
    ...
    g_pParticleSystems[5]->SetVelocityVar( 10.0f );
	...
	g_pParticleSystems[6]->SetMaxParticles(800);
	g_pParticleSystems[6]->SetNumToRelease(60);
	g_pParticleSystems[6]->SetReleaseInterval(0.05f);
	g_pParticleSystems[6]->SetLifeCycle(5.5f);
	g_pParticleSystems[6]->SetSize(60.0f);
	g_pParticleSystems[6]->SetColor(MyVector(1.0f, 0.0f, 1.0f));
	g_pParticleSystems[6]->SetPosition(MyVector(0.0f, -1.0f, 0.0f));
	g_pParticleSystems[6]->SetVelocity(MyVector(0.0f, 0.0f, 0.0f));
	g_pParticleSystems[6]->SetGravity(MyVector(0.0f, -3.8f, 0.0f));
	g_pParticleSystems[6]->SetWind(MyVector(-4.0f, 0.0f, 0.0f));
	g_pParticleSystems[6]->SetVelocityVar(10.0f);
	...
	g_pParticleSystems[6]->SetCollisionPlane(MyVector(1.0f, 0.0f, 0.0f),
		MyVector(-5.0f, 0.0f, 0.0f)); // Left Wall

	g_pParticleSystems[6]->SetCollisionPlane(MyVector(-1.0f, 0.0f, 0.0f),
		MyVector(5.0f, 0.0f, 0.0f)); // Right Wall

	g_pParticleSystems[6]->SetCollisionPlane(MyVector(0.0f, 0.0f, 1.0f),
		MyVector(0.0f, 0.0f, -6.0f)); // Front Wall

	g_pParticleSystems[6]->SetCollisionPlane(MyVector(0.0f, 0.0f, -1.0f),
		MyVector(0.0f, 0.0f, 6.0f)); // Back Wall
